...
export default {
    ...
    // },
    // mounted: function(){
    //     console.log('UserProfileDetail.vue loaded!')
    ...
    //     // }
    //     // canShowOtherProfile: function() {     //other user profile view mode
    //     //     console.log('canShowOtherProfile')
    //     //     return this.otherUser && this.showUserProfileDetail //どっちかがtureだったらture, どっちともfalseだったらfalseを返す
    //     // },
    //     // canShowMyProfile: function() {     //my profile view mode
    //     //     console.log('canShowMyProfile')
    //     //     return !this.otherUser && this.showUserProfileDetail //どっちかがtureだったらture, どっちともfalseだったらfalseを返す
    //     // },
    //     // modeSelectComplete: function() {     //
    //     //     console.log('modeSelectComplete!!')
    //     //     return this.showUserProfileDetail //どっちかがtureだったらture, どっちともfalseだったらfalseを返す
    //     // },
    // },
    ...
    watch:  {
        ...
        showUserProfileDetail: function() {    //ダイアログが開いた(閉じた)時に実行するメソッド
            console.log('showUserProfileDetail loaded')
        ...
        // modeSelectComplete: function() {    //ダイアログが開いた(閉じた)時に実行するメソッド
        //     if(!this.modeSelectComplete) return;
        //     this.isLoading = true; 
        //     this.my_spot = []; // 作成スポット
        //     this.good_spot = []; // レビューしたスポット
        //     this.spot_to_show = []; // TODO: 表示するスポットの制限
